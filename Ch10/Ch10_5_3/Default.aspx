...
<body>
    ...
    <div>
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="sid" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" AllowPaging="True" Width="241px">
            <EditItemTemplate>
                學號:
